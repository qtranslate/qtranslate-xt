...
function qtranxf_conf() {
	...
	<?php if ( isset( $_GET['edit'] ) ) { ?>
		...
		<?php if ( isset( $_GET['config_inspector'] ) ) {
			...
			?>
            <p class="qtranxs-notes"><a
                        href="<?php echo admin_url( 'options-general.php?page=qtranslate-xt#integration' ) ?>"><?php _e( 'back to configuration page', 'qtranslate' ) ?></a>
            </p>
            ...
            <p class="qtranxs_explanation">
				...
				echo ' ';
				printf( __( 'Please, read %sIntegration Guide%s for more information.', 'qtranslate' ), '<a href="https://qtranslatexteam.wordpress.com/integration/" target="_blank">', '</a>' ); ?></p>
            <p class="qtranxs_explanation"><textarea class="widefat"
                                                     rows="30"><?php echo esc_textarea( str_replace( '[]', '{}', qtranxf_json_encode( $configs ) ) ); ?></textarea>
            </p>
                ...
                <div class="tabs-content"><?php //<!-- tabs-container --> ?>
                    ...
                    <table class="form-table qtranxs-form-table" id="qtranxs_general_config">
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="camel_case"><input type="checkbox" name="camel_case" id="camel_case"
                    ...
                    <table class="form-table qtranxs-form-table" id="qtranxs_advanced_config">
                        ...
                        <tr>
                            ...
                            <td>
								<?php echo trailingslashit( content_url() ) ?><input type="text" name="flag_location"
                                                                                     id="flag_location"
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="header_css_on"><input type="checkbox" name="header_css_on"
                                                                  id="header_css_on"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br/>
                                <label for="use_secure_cookie"><input type="checkbox" name="use_secure_cookie"
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="auto_update_mo"><input type="checkbox" name="auto_update_mo"
                                                                   id="auto_update_mo"
                                ...
                                <br/>
                                <label for="update_mo_now"><input type="checkbox" name="update_mo_now"
                                                                  id="update_mo_now"
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="radio" name="use_strftime"
					...
					*/ ?>
                        ...
                        <tr id="option_editor_mode">
                            ...
                            <td>
                                <label for="qtranxs_editor_mode_lsb"><input type="radio" name="editor_mode"
                                ...
                                <br/>
                                <label for="qtranxs_editor_mode_raw"><input type="radio" name="editor_mode"

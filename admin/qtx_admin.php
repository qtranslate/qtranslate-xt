...
function qtranxf_nav_menu_metabox( $object ) {
    ...
    <div id="qtranxs-langsw" class="qtranxslangswdiv">
		...
		<span class="hide-if-js" id="qtranxs-langsw-help"><p><a name="qtranxs-langsw-help"></a>
				...
				echo ' ';
				printf( __( 'The field "%s" of inserted menu item allows additional configuration described in %sFAQ%s.', 'qtranslate' ), qtranxf_translate_wp( 'URL' ), '<a href="https://github.com/qtranslate/qtranslate-xt/wiki/FAQ#language-switcher-menu-config" target="_blank">', '</a>' ) ?></p>
		</span>
	</span>
